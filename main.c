...
/*
TIES SITA VIETA PRADEDAMAS NEBEMATYTI USB
============
while (NRF_RADIO->EVENTS_END == 0U) ; // Wait for end of packet or buttons state changed
============
*/
...
LED_Control(result-1); 

// kolkas veikia naudojant tik sita viena cikla. if(m_send_flag) galima nenaudot.
...
*/
      ...
      //  uint32_t result = packet; // received data from RADIO
        LED_Control(result-1); 
